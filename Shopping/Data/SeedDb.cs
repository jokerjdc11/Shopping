...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        {
            // Crear la base de datos y aplica las migraciones pendientes
            await _context.Database.EnsureCreatedAsync();
            await CheckCategoriesAsync();
            await CheckCountryAsync();
            await CheckRoles();
            await CheckUserAsync("1010", "Juan", "Zuluaga", "zulu@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("1010", "Juan", "callese", "callese@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", UserType.User);
        }
                    ...
                    States = new List<State>()
                    {
                        new State
                        {
                            ...
                            Cities = new List<City>
                            {
                                ...
                                new City { Name = "Villamaria"},
                                new City { Name = "Chinchina"},
                            }
                        },
                        new State
                        {
