...
namespace Shopping.Controllers
{
    public class CountriesController : Controller
    {
        ...
        {
            //Buscamos el pais con sus respectivos estados es como un inner join con include
        ...
        public async Task<IActionResult> AddState(int? id)
        {
            ...
            // validamos si el estado existe y esperamos la respuesta si no exite no retornamos nada
            if (country == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> AddState(StateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        ModelState.AddModelError(string.Empty, "Ya existe un departamento/estado con el mismo nombre de país.");
                    }
                    else
                    {
                        ModelState.AddModelError(string.Empty, dbUpdateException.InnerException.Message);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            //Busque por id pero tambien traigame los estados
            var country = await _context.Countries
                .Include(c => c.States)
                .FirstOrDefaultAsync(c => c.Id == id);
        ...
        public async Task<IActionResult> DeleteCityConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(DetailsState), new
            {
                Id = city.State.Id
            });
        }
